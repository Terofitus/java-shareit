...
public class BookingController {
    ...
    public ResponseEntity<Object> bookItem(@RequestHeader("X-Sharer-User-Id") long userId,
                                           @RequestBody @Valid BookingDtoForCreateUpdate requestDto) {
    ...
    @GetMapping("/owner")
    public ResponseEntity<Object> getAllBookingsByOwnerIdAndState(@RequestHeader("X-Sharer-User-Id") Integer userId,
        ...
        ValidatingOfPageable.checkParams(from, size);
        return bookingClient.getAllBookingsByOwnerIdAndState(userId, stateB, from, size);
    }
    ...
    public ResponseEntity<Object> deleteAllBookingsByOwnerId(@RequestHeader("X-Sharer-User-Id") Integer ownerId) {
        return bookingClient.deleteAllBookingsByOwnerId(ownerId);
    }
}
